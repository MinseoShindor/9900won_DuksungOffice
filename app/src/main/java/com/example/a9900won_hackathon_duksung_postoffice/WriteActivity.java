...
public class WriteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter Adapter4 = ArrayAdapter.createFromResource(this, R.array.pick_2_2_3, android.R.layout.simple_spinner_dropdown_item);
        ...
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int p, long id) {
                ...
                Log.d(spinnerText1, "spinner text1: ");
                //일반 선택시
                if(spinnerText1 == "일반") {
                    ...
                    spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Log.d(spinnerText2, "spinner text2: ");
                        ...
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            spinner3.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                ...
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    Log.d(spinnerText3, "spinner text2: ");
                                }
                                @Override
                                public void onNothingSelected(AdapterView<?> parent) {
